...
const navItemsByLanguage: Record<Language, Array<{ label: string; href: string }>> = {
  de: [
          ...
          {languages.map((lang) => (
            <button
              ...
              className={cn(
                ...
                language === lang && styles["site-header__language-button--active"],
              )}
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button variant="ghost" size="sm">
                <Menu size={20} />
                <span className={styles["site-header__sr-message"]}>{srMessageByLanguage[language]}</span>
              </Button>
            </SheetTrigger>
            <SheetContent>
              <div className={styles["site-header__sheet-content"]}>
                <div className={styles["site-header__sheet-brand"]}>{content.brandName}</div>
