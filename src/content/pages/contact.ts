  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Reach out",
        body:
          "Whether you are interested in products, retreats, or rentals – share a short note about your plans and we will shape the right framework.",
      },
    ],
    cta: {
    ...
    creditsHeading: "Credits",
    credits: [
      "Photos: Maximilian Salzer – www.maximiliansalzer.com",
    ],
  },
};
