    ...
    sections: [
      {
        ...
        title: "Retreat area",
        body:
          "The seminar area is self-contained, bright, and open. Wood, warm colors, and views into the greenery help groups focus on their content. When temperatures drop, the wood stove provides heat.",
      },
      {
        kind: "facts",
        title: "Amenities",
        items: [
          {
            label: "Seminar room",
            value: "About 70 m², flooded with light, equipped with chairs, meditation cushions, yoga mats, and a wood stove.",
          },
          {
            label: "Infrastructure",
            value: "Small kitchen with seating area plus separate restroom and shower exclusively for guests.",
          },
          {
            label: "Outdoor spaces",
            value: "Pond hut, labyrinth, tree tent, sweat lodge, and quiet forest clearings.",
          },
        ],
      },
      {
