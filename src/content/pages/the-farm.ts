    ...
    sections: [
      {
        ...
        body:
          "I have been stewarding the Oberhof since 2014 and see it as an interconnected system where people, animals, and landscape strengthen one another. We observe natural cycles, practice ecological agriculture, and draw inspiration from traditional techniques.",
      },
      {
        kind: "bullets",
        title: "Our approach",
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: "Workshops",
            value: "A small retreat center that offers space for workshops and nature experiences.",
          },
        ],
      },
    ],
